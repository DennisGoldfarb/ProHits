...
//modified from (c) Alf Magne Kalleland, http://www.dhtmlgoodies.com - 2005
class dhtmlgoodies_tree{
	var $elementArray = array();
	var $initExpandedNodes = "";
	function dhtmlgoodies_tree($ini='')
	{
	...
	function drawLi($id,$name,$imageIcon="", $checked = ""){
		if(!$imageIcon){
		  ...
		  $imageIcon = "<img src=\"$imageIcon\" alt=$id>";
			$tmp_lable = "<input name=rawbox type=checkbox value=". $id . $checked.">".$name;
		}
