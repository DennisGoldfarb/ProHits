...
require_once("analyst/common_functions.inc_dev.php");
          ...
          foreach($rawFileInfoArr as $rawValue){
         	  ...
         	  if(count($fileTableIDarr) == 2){
                ...
                $subFlag = '';
                  ...
                  $SampleMess .= "&nbsp;<a class='sTitle' title='raw file detail' href=\"javascript: popwin('$pop_file_name',550,380)\">[detail]</a>";
               	}
             	}
         	  }
