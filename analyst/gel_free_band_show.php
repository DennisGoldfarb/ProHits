...
<table border=0 cellpadding="0" cellspacing="0" width="97%">
  ...
  <tr>
    <td align="left">
    <font color="navy" face="helvetica,arial,futura" size="3"><b>Sample Report
    <?php 
    ...
    <td align="right">
      ...
      <a href="export_file.php?file=<?php echo $filename;?>" class=button>[Export Sample Report]</a>           
      ...
      <a href="javascript: print_view('sample_report_print_view.php?frequencyLimit=<?php echo $frequencyLimit;?>');" class=button>[Print Preview]</a> 
      <a href="./band_show.php<?php echo ($sub)?"?sub=$sub":"";?>" class=button>[Back to Sample List]</a>
    </td>
  </tr>
            ...
            for($k=0;$k<count($ExpCDT);$k++){
  	        ...
  	        ?>
                ...
                <tr>
                  ...
                  <td><div class=maintext>Exp. Status:</div></td>
                  <td nowrap><div class=maintext>&nbsp;<?php get_status($Band_ID,$HITSDB,'1','Band')?></b></div></td>
                  ...
                  <td colspan=3><div class=maintext><b><?php echo $exConditions;?></b></div></td>
      	        </tr>
  	        <?php 
              ...
              fwrite($handle, "Sample ID: ".$Band_ID.",Sample Name: ".$SampleInfo['Location'].",Band Observed MW: ".$SampleInfo['BandMW'].",Submitted by: ".$theUser);
              fwrite($handle, ",Exp ID: ".$Exps['ID'].",Date: ".$SampleInfo['DateTime'].",Condition: $exConditions\n\n");
              fwrite($handle, "\n"); 
            ?>
             </table>
            </td>
...
?>
  <tr>
      ...
      <td align="right">          
        <a href="javascript:show_all_peptides('<?php echo $Band_ID;?>');">Sample Report (peptide detail)</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>         
  </tr>
...
while(list(
  ...
  $SearchDatabase,
  $DateTime,
  $SearchEngine)= mysqli_fetch_row($sqlResult) ){
