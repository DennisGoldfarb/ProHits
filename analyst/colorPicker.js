...
function ColorPicker_writeDiv() {
	document.writeln("<DIV ID=\"colorPickerDiv\" STYLE=\"position:absolute;visibility:hidden;border: black solid 1px;\"> </DIV>");
	}
...
function ColorPicker_pickColor(color,obj) {
	...
	pickColor(color);
  //alert(color);
	addTableRow(color,'');//-----put functio here----------------------
	}
...
function ColorPicker() {
	...
	cp_contents += "<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=0 bgcolor=white>";
	...
	if (document.getElementById) {
		...
		cp_contents += "<TR><TD COLSPAN='"+width1+"' BGCOLOR='#ffffff' ID='colorPickerSelectedColor'>&nbsp;</TD><TD COLSPAN='"+width2+"' ALIGN='CENTER'><A HREF='#' onClick='"+windowRef+"window.popupWindowObjects["+cp.index+"].hidePopup();return false;'>[Close]</A></TD></TR>";
		}
	cp_contents += "</TABLE>";
	if (windowMode) {
