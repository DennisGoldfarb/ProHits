...
//    }
    ...
    var default_options = {
		...
		swfPath: path(PROHITS_WEB_PATH+"/common/javascript/cytoscape_web/swf/CytoscapeWeb"),
		flashInstallerPath: path(PROHITS_WEB_PATH+"/common/javascript/cytoscape_web/swf/playerProductInstall"),
		preloadImages: true,
		useProxy: false
    };
...
//        update_vizmapper(); // lazy initialization, instead...
    ...
    function create_open(){
        var options = {
                swfPath: path(PROHITS_WEB_PATH+"/common/javascript/cytoscape_web/swf/Importer"),
                flashInstallerPath: path(PROHITS_WEB_PATH+"/common/javascript/cytoscape_web/swf/playerProductInstall"),
                data: function(data){
    ...
    function create_save(){
        ...
        function make_selection(fn, title, description, isImage, binary){
            ...
            var options = {
                    swfPath: path(PROHITS_WEB_PATH+"/common/javascript/cytoscape_web/swf/Exporter"),
                    flashInstallerPath: path(PROHITS_WEB_PATH+"/common/javascript/cytoscape_web/swf/playerProductInstall"),
                    base64: binary,
                	data: function(){
                		return vis[fn]();
